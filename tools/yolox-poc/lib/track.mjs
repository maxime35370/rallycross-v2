...
// L'affectation hongroise vit désormais dans js/vision/hongrois.js : elle sert
// aussi à l'analyse du premier virage, qui n'a que faire du suivi temporel.
import { hungarian } from '../../../js/vision/hongrois.js';
export { hungarian };
