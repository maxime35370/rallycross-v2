...
const CACHE_NAME = 'rx-chrono-v36';
...
const ASSET_PATHS = [
  ...
  'js/startStats.js',
  'js/videoPlayerCalc.js',
  'js/projection/projectionConfig.js',
  'js/projection/qualificationRules.js',
  'js/projection/qualificationState.js',
